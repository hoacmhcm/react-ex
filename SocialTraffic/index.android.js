...
import { AppRegistry, Platform, Image, StatusBar, StyleSheet, Text, TouchableHighlight, View } from 'react-native';
    ...
    render() {
        return (
            <View style={styles.container}>
                <Map  mapStyle={styles.map} showsUserLocation={this.state.showGeo} followUserLocation={this.state.showGeo} ></Map>
...
AppRegistry.registerComponent('SocialTraffic', () => Main);
